  ...
  const dummyPost: TPost[] = [
    {
      thumb: '/demo1.jpeg',
      title:
        'The true Church established by Second Coming Christ Ahnsahnghong according to the prophecies of the Bible',
      url: 'slug-of-blog',
    },
    {
      thumb: '/demo2.jpeg',
    ...
    <div className='flex flex-col gap-20'>
      <div className='flex flex-col items-center gap-10'>
        ...
        <Avatar
          ...
          alt='avatar'
          className='flex h-[240px] w-[240px] flex-shrink-0'
        />
        <p className='text-center'>
          The New Covenant Passover blesses the eternal life with bread and wine
        </p>
      </div>
